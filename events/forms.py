...
class RegisterForm(forms.Form):
    ...
    candidate_phone = forms.CharField(validators=[phone_regex], label='Phone number:', max_length=14, required=False, widget=forms.TextInput(attrs={'placeholder': 'XXX-XXX-XXXX'}))
